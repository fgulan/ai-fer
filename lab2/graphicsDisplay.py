...
GHOST_COLORS = []
GHOST_COLORS.append(formatColor(1, 1, 1)) #White Wumpusghost
GHOST_COLORS.append(formatColor(1, 0, 0)) #Red Wumpusghost
...
# Capsule graphics
CAPSULE_COLOR = formatColor(75./255., 0., 130./255.)
CAPSULE_SIZE = 0.25
...
class PacmanGraphics:
        ...
        for xNum, x in enumerate(foodMatrix):
            ...
            for yNum, cell in enumerate(x):
                if cell: # There's food here
                    ...
                    #dot = image((xNum, yNum), './im/teleporter.jpeg')
                    imageRow.append(dot)
                else:
    ...
    def drawTeleporter(self, teleporter):
        pass
