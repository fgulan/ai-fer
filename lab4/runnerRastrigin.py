...
if __name__ == '__main__':
    ...
    populationSize = 5 # The number of chromosomes
    mutationProbability = .2  # Probability of mutation
    mutationScale = 0.15  # Standard deviation of the gaussian noise
    numIterations = 30000  # Number of iterations to run the genetic algorithm for
